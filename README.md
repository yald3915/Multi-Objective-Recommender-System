This file is the baseline code for OTTO – Multi-Objective Recommender System--Build a recommender system based on real-world e-commerce sessions

以上文件是OTTO – Multi-Objective Recommender System--Build a recommender system based on real-world e-commerce sessions（多目标推荐系统）比赛的baseline代码
